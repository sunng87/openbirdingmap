...
* [`src/obmweb/`](src/obmweb/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/obmweb/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `obmweb` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/obmweb/config.cljs) defaults to `true` in
...
```clj
(ns obmweb.example
  (:require [obmweb.config :as config])
